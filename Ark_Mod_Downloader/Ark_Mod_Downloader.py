...
#example usage
# python3 /home/steam/Ark_Mod_Downloader/Ark_Mod_Downloader.py --modids 895711211 --workingdir /home/steam/ark_server_files/
...
class ArkModDownloader():
    ...
    def __init__(self, steamcmd, modids, working_dir, mod_update, modname, preserve=False):
        ...
        self.steamcmd = steamcmd  # Path to steamcmd binary
        ...
        self.temp_mod_path = ("/home/steam/.steam/steamapps/workshop/content/346110")
    ...
    def steamcmd_check(self):
        ...
        # Check default Ubuntu installation directory
        if os.path.isfile(os.path.join(self.working_dir, "/usr/games/steamcmd")):
            print("[+] Located SteamCMD")
            self.steamcmd = os.path.join(self.working_dir, "/usr/games/steamcmd")
            return True

        print("[+} SteamCMD Not Found Exiting...")
        return False
    ...
    def download_mod(self, modid):
        ...
        arg = self.steamcmd + " +login anonymous +workshop_download_item 346110 " + modid + " +quit"
    ...
    def move_mod(self, modid):
        ...
        arg = "mv " + output_dir + "/" + modid + ".mod" + " " + ark_mod_folder
        subprocess.call(arg, shell=True)
